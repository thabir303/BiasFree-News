...
const ManualScrapingPage = () => {
  ...
  const newspapers: Newspaper[] = [
    { key: 'prothom_alo', name: 'Prothom Alo', base_url: 'prothomalo.com', language: 'bn', enabled: true },
    { key: 'daily_star', name: 'The Daily Star', base_url: 'bangla.thedailystar.net', language: 'en', enabled: true },
    { key: 'jugantor', name: 'Jugantor', base_url: 'jugantor.com', language: 'bn', enabled: true },
    { key: 'samakal', name: 'Samakal', base_url: 'samakal.com', language: 'bn', enabled: true },
    { key: 'naya_diganta', name: 'Naya Diganta', base_url: 'dailynayadiganta.com', language: 'bn', enabled: true },
    { key: 'ittefaq', name: 'Ittefaq', base_url: 'ittefaq.com.bd', language: 'bn', enabled: true },
  ];
